...
A personal Flutter food-delivery app I built to explore Flutter UI, simple state management, and a polished mobile experience. Built and maintained by Your Name — replace this with your real name.

Highlights
- Clean Flutter UI with pages for popular and recommended food
- Cart with history and controllers for state management
- Localized strings in `assets/language`
